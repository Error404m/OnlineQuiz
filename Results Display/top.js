...
var test = new BFG.Leaderboard({
	...
	dataCallback:function(){
		return [//simulates incoming data
			{id:1,title:"Satyam Singh Virat",count:BFG.rnd(1,1)},
			{id:2,title:"Hardik Sharma",count:BFG.rnd(2,2)},
			{id:3,title:"Rajat Panwar",count:BFG.rnd(3,3)},
			{id:4,title:"Abhay Gupta",count:BFG.rnd(4,4)},
			{id:5,title:"Shivansh Dubey",count:BFG.rnd(5,5)},
			{id:6,title:"POOJA DHIMAN",count:BFG.rnd(6,6)},
			{id:7,title:"PUSHPIT SURI",count:BFG.rnd(7,7)},
			{id:8,title:"SHASHWAT",count:BFG.rnd(8,8)},
			{id:9,title:"JYOTSNA DWIVEDI",count:BFG.rnd(9,9)},
			{id:10,title:"ShIVANGI GUPTA",count:BFG.rnd(10,10)}
